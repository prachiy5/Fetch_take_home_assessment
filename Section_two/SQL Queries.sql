...
-- Retrieve the top 5 brands by total sales among eligible users
SELECT 
    TOP 5 p.BRAND, 
    SUM(t.FINAL_SALE) AS TOTAL_SALES  -- Sum of all sales for each brand
...
ORDER BY TOTAL_SALES DESC;  -- Sort in descending order to get top brands
